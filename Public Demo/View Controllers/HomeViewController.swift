...
class HomeViewController: UIViewController {
    ...
    private func performLogout() {
        ...
        let loginID = UserDefaults.standard.value(forKey: Constants.loginID) as! String
...
extension HomeViewController: UITableViewDelegate {
    ...
    private func locationTapped() {
        ...
        alert.addAction(UIAlertAction(title: "Best Accuracy", style: .default, handler: { (action) in
            WebEngage.sharedInstance()?.autoTrackUserLocation(with: .best)
        }))
        
        alert.addAction(UIAlertAction(title: "City Accuracy", style: .default, handler: { (action) in
            WebEngage.sharedInstance()?.autoTrackUserLocation(with: .forCity)
        }))
        
        alert.addAction(UIAlertAction(title: "Country Accuracy", style: .default, handler: { (action) in
            WebEngage.sharedInstance()?.autoTrackUserLocation(with: .forCountry)
        }))
        
        alert.addAction(UIAlertAction(title: "Disable Location Tracking", style: .destructive, handler: { (action) in
